...
<div class="page-wrapper">
    ...
    <div class="page-header card">
        <div class="card-block">
            <h5 class="m-b-10">Create Supplier</h5>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" name="supplier_no"
                                        class="form-control @error('supplier_no') is-invalid @enderror"
                                        placeholder="Supplier No" value="{{ old('supplier_no', $supplier_no) }}" readonly>
                                    @error('supplier_no')
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" name="tax_no"
                                        class="form-control @error('tax_no') is-invalid @enderror" placeholder="Tax No"
                                        value="{{ old('tax_no') }}">
                                    @error('tax_no')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
